package com.martn.weekend.view.circlerefresh;
...
public class CircleRefreshLayout extends FrameLayout {
    ...
    public void setAniStatus(AnimationView.AnimatorStatus status) {
        mHeader.setAniStatus(status);
    }
    ...
    public AnimationView.AnimatorStatus getAniStatus() {
        return mHeader.getAniStatus();
    }
